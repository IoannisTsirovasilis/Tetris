...
import TetrisQLearning as Tetris
...
def create_q_model():
    ...
    layer1 = layers.Conv2D(16, 2, activation="relu")(inputs)
    layer2 = layers.Conv2D(32, 2, activation="relu")(layer1)
    layer3 = layers.Conv2D(32, 2, activation="relu")(layer2)
