...
from VideoProcessing import GameControllerIdea as GameController, TetrisQLearningIdea as Tetris
...
INPUT_SHAPE = ((GameController.BOARD_HEIGHT - 2) * GameController.ENLARGE_FACTOR, GameController.BOARD_WIDTH * GameController.ENLARGE_FACTOR, 1)

print("Enlarge Factor")
sleep(1)
