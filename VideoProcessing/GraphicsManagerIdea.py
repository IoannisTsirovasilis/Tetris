import pygame as pg
import VideoProcessing.GameControllerIdea as GameController
...
class GraphicsManager:
    def __init__(self, width, height):
        ...
        self.BOARD_PIXELS = pg.display.get_surface().subsurface(pg.Rect((409, 150), (370, 740)))
    ...
    def draw_text(self, font, size, text, color, pos_x, pos_y):
        ...
        self.BOARD_PIXELS.unlock()
        pg.display.get_surface().unlock()
